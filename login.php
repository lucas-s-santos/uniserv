                ...
                <div class="dentro form-card">
                    ...
                    <div class="form-grid form-grid--single">
                        <input type="hidden" name="csrf_token"
                            value="<?php echo htmlspecialchars($csrf_login, ENT_QUOTES, 'UTF-8'); ?>">
                        <div class="campo-texto">
                            <label>Digite o seu CPF</label>
                            <input type="text" name="cpf_login" id="cpf" placeholder="000.000.000-00"
                                value="<?php echo htmlspecialchars($old_login_cpf, ENT_QUOTES, 'UTF-8'); ?>"
                                autocomplete="username" inputmode="numeric" required>
                        </div>
                        <div class="campo-texto">
                            <label>Digite a senha</label>
                            <input type="password" name="senha_login" id="senha" placeholder="Digite sua senha"
